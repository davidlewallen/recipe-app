module.exports = {
  ...
  foodnetwork: {
    ...
    instructions: [
      ...
      '4) Line a cupcake pan with 7 paper liners. Fill the cupcake liners 2/3 full with batter.',
      '5) Remove 2 2/3 cups batter from the bowl and place it in a separate bowl. Stir in the mint extract and red food color.',
      '6) Spray a 4-cup bundt pan and a 10-cup bundt pan with flour-based baking spray. Alternate layers of vanilla batter and mint (red) batter in each bundt pan until the pans are about 3/4 full. Use a butter knife to gently swirl the two batter colors together.',
  ...
  realsimple: {
    ...
    instructions: ['1) Combine mushrooms and 2 cups of the stock in a saucepan. Bring to a boil over high; remove from heat, and let stand 45 minutes to 1 hour.',
